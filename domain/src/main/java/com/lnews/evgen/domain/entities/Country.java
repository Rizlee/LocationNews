...
public class Country {
    public static final String[] COUNTRY_NAMES = {
        ...
        "Ireland", "Israel", "India", "Italy", "Japan", "Korea, Republic of", "Lithuania", "Latvia",
        "Morocco", "Mexico", "Malaysia", "Nigeria", "Netherlands", "Norway", "New Zealand",
        "Philippines", "Poland", "Portugal", "Romania", "Serbia", "Russia", "Saudi Arabia",
        "Sweden", "Singapore", "Slovenia", "Slovakia", "Thailand", "Turkey",
        "Taiwan, Province of China", "Ukraine", "Venezuela", "South Africa"
    };
